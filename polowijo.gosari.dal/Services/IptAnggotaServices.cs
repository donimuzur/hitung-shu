            ...
            using (OleDbCommand _command = new OleDbCommand())
            {
                ...
                using (OleDbDataReader _dr = _command.ExecuteReader())
                {
                    ...
                    foreach (DataRow row in _dt.AsEnumerable())
                    {
                        ...
                        Dto.Pokok = Convert.ToDecimal(row["pokok"]);
                        Dto.Wajib = Convert.ToDecimal(row["wajib"]);
                        Dto.Sukarela = Convert.ToDecimal(row["sukarela"]);
                        Dto.Belanja = Convert.ToDecimal(row["belanja"]);
                        Dto.BungaPinjaman = Convert.ToDecimal(row["bunga_pinjaman"]);
