            ...
            using (OleDbCommand _command = new OleDbCommand())
            {
                ...
                using (OleDbDataReader _dr = _command.ExecuteReader())
                {
                    ...
                    foreach (DataRow row in _dt.AsEnumerable())
                    {
                        ...
                        Dto.TotalShu = Convert.ToDecimal(row["total_shu"]);
                        Dto.TotalSimpanan = Convert.ToDecimal(row["total_simpanan"]);
                        Dto.TotalPenjualan = Convert.ToDecimal(row["total_penjualan"]);
                        Dto.TotalPinjaman = Convert.ToDecimal(row["total_pinjaman"]);
